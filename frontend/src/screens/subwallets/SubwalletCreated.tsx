                        ...
                        <Popover>
                          ...
                          <PopoverContent className="flex flex-col items-center gap-3">
                            <div className="text-center text-xs text-muted-foreground">
                              Install Zapstore on your Android device and search
                              for <span className="font-semibold">Alby Go</span>
                            </div>
                ...
                <AccordionContent>
                  <ul className="flex flex-col gap-1 list-inside list-decimal mb-6">
                    <li>
                      ...
                      them to create an Alby Account on getalby.com or send them
                      an{" "}
                      <ExternalLink
                ...
                <AccordionContent>
                  <ul className="list-inside list-decimal flex flex-col gap-1 mb-6">
                    ...
                    <li>
                      ...
                      <span className="font-medium">Bring Your Own Wallet</span>{" "}
              ...
              <AccordionItem value="other">
                ...
                <AccordionContent>
                  ...
                  <div className="grid gap-1.5">
                    <Label htmlFor="connectionSecret">Connection Secret</Label>
                    <div className="flex gap-2">
                      <Input
                        id="connectionSecret"
                        disabled
              ...
              <AccordionItem value="podcasting">
                ...
                <AccordionContent>
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="grid gap-1.5">
                      <Label htmlFor="podcastValueTag">podcast:value tag</Label>
                      <Textarea
                        id="podcastValueTag"
                        readOnly
                        className="h-32"
                    ...
                    <Alert>
                      ...
                      <AlertDescription>
                        This connection will allow them to receive payments from
                        their podcast audience. To allow them to spend the
                        funds, make sure they are connected to other options
                        like Alby Go or Alby Account.
                      </AlertDescription>
                    </Alert>
                  </div>
                </AccordionContent>
